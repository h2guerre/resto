         ...
         items.innerHTML=data.map((item)=>{
            ...
            return`
                  ...
                  <div class="card">
                        ...
                        <p class='info_pr'>
                              <span>${item.prixProd}Fcfa</span>
                              <span> Desc: ${item.descriProd}</span>
                        </p>
                        <div class='btns'>
                              <a class='modif_btn' href="traitement.php?action=modify&amp;id=${item.idProd}"><button class='btn btn-danger' style='font-weight:bolder'>Edit<i class='fas fa-pen'></i></button></a>
                              <a class='del_btn' href="traitement.php?action=del&amp;id=${item.idProd}"> <button class='btn btn-danger'><i class='fas fa-trash'></i></button></a>
      ...
      if(req.ok)
      {
          ...
          container.innerHTML=res.map((item)=>{
               ...
               <div class="card">
                   ...
                   <div class='btns'>
                         <a class='modif_btn' href="traitement.php?action=modify&amp;id=${item.idProd}"><button class='btn btn-danger'>Edit<i class='fas fa-pen'></i></button></a>
                         <a class='del_btn' href="traitement.php?action=del&amp;id=${item.idProd}"> <button class='btn btn-danger'><i class='fas fa-trash'></i></button></a>
